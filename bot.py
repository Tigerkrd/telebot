...
admin_id = '6053890688'  # اي دي بتاعك هنا
bot = telebot.TeleBot("6488168238:AAERzyVlLSqGsv10Y0iIDqKS_tCtkS2F7r4")# توكن بتاعك هنا
#AddUser
def load_users():
    try:
...
def handle_ba_command(message):
    try:
        ...
        #تحط بواباتك هنا بالشكل ده
    except Exception as e:
        print(e)#Or send it to your telegram channel to see the error Bro
#GateLogic Ends
